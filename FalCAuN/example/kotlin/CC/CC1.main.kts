 ...
 *
 *  USAGE
 *   ./CC1.main.kts original|ppartial|abstract
 *
 ********/
...
logger.info("This is the script to falsify the chasing car benchmark against the CC1 formula by FalCAuN-with-SGA")
