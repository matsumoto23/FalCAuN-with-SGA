 ...
 *
 *  USAGE
 *   ./CC2.main.kts original|ppartial|abstract
 *
 ********/
...
logger.info("This is the script to falsify the chasing car benchmark against the CC2 formula by FalCAuN-with-SGA")
...
val y5y4Values = listOf(10.0, 11.0, 12.0, null)
...
val stlList =
    listOf(
        "(alw_[0,${(70 / signalStep).toInt()}] ev_[0,${(30 / signalStep).toInt()}] ($diffy5y4 > 10 && $diffy4y3 > 10))",
        "(alw_[0,${(70 / signalStep).toInt()}] ev_[0,${(30 / signalStep).toInt()}] ($diffy5y4 > 11 && $diffy4y3 > 11))",
        "(alw_[0,${(70 / signalStep).toInt()}] ev_[0,${(30 / signalStep).toInt()}] ($diffy5y4 > 12 && $diffy4y3 > 12))"
