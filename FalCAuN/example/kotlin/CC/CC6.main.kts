 ...
 *
 *  USAGE
 *   ./CC6.main.kts original|ppartial|abstract
 *
 ********/
...
logger.info("This is the script to falsify the chasing car benchmark against the CC6 formula by FalCAuN-with-SGA")
...
val stlList =
    listOf(
        "(alw ($diffy2y1 > 40.0 -> $diffy3y2 < 40.0))",
        "(alw ($diffy3y2 > 40.0 -> ($diffy2y1 < 40.0 || $diffy4y3 < 40.0) ))",
        "(alw ($diffy4y3 > 40.0 -> ($diffy3y2 < 40.0 || $diffy5y4 < 40.0) ))",
        "(alw ($diffy5y4 > 40.0 -> $diffy4y3 < 40.0))",
