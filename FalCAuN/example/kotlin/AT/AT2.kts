...
val stlList = listOf(
    "[] (signal(0) < 90 && signal(1) < 4600)",
    "[] (signal(0) < 90 && signal(1) < 4700)",
    "[] (signal(0) < 95 && signal(1) < 4600)",
    "[] (signal(0) < 95 && signal(1) < 4700)",
    "[] (signal(0) < 100 && signal(1) < 4600)",
    "[] (signal(0) < 100 && signal(1) < 4700)",
    "[] (signal(0) < 105 && signal(1) < 4600)",
    "[] (signal(0) < 105 && signal(1) < 4700)"
