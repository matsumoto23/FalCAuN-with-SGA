...
val velocityValues = listOf(20.0, null)
...
val stlList = listOf(
    ...
    "[] (signal(2) == 3 -> <>_[0,1] (signal(0) > 20))",
    "[] (signal(2) == 3 -> <>_[0,2] (signal(0) > 20))",
    "[] (signal(2) == 3 -> <>_[0,3] (signal(0) > 20))",
    "[] (signal(2) == 3 -> <>_[0,4] (signal(0) > 20))",
    "[] (signal(2) == 3 -> <>_[0,5] (signal(0) > 20))",
    "[] (signal(2) == 3 -> <>_[0,6] (signal(0) > 20))",
    "[] (signal(2) == 3 -> <>_[0,7] (signal(0) > 20))",
    "[] (signal(2) == 3 -> <>_[0,8] (signal(0) > 20))",
    "[] (signal(2) == 3 -> <>_[0,9] (signal(0) > 20))",
    "[] (signal(2) == 3 -> <>_[0,10] (signal(0) > 20))"
...
SimulinkSUL(initScript, paramNames, signalStep, simulinkSimulationStep).use { autoTransSUL ->
    ...
    verifier.setTimeout(20 * 60) // 2 minutes
