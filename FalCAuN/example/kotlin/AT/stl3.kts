...
val velocityValues = listOf(85.0, 90.0, 95.0, 100.0, null)
val accelerationValues = listOf(4600.0, 4650.0, null)
...
val stlList = listOf(
    "[] (signal(0) < 85 || signal(1) < 4600)",
    "[] (signal(0) < 85 || signal(1) < 4650)",
    "[] (signal(0) < 90 || signal(1) < 4600)",
    "[] (signal(0) < 90 || signal(1) < 4650)",
    "[] (signal(0) < 95 || signal(1) < 4600)",
    "[] (signal(0) < 95 || signal(1) < 4650)",
    "[] (signal(0) < 100 || signal(1) < 4600)",
    "[] (signal(0) < 100 || signal(1) < 4650)",
