...
val stlList = listOf(
    "[] ((signal(2) == 1 -> signal(0) < 35) && (signal(2) == 2 -> signal(0) < 65))",
    "[] ((signal(2) == 1 -> signal(0) < 35) && (signal(2) == 2 -> signal(0) < 70))",
    "[] ((signal(2) == 1 -> signal(0) < 40) && (signal(2) == 2 -> signal(0) < 65))",
    "[] ((signal(2) == 1 -> signal(0) < 40) && (signal(2) == 2 -> signal(0) < 70))"
