...
val velocityValues = listOf(90.0, 95.0, 100.0, 105.0, null)
val accelerationValues = listOf(4600.0, 4700.0, null)
...
val stlList = listOf(
    "[]_[6,10] (signal(0) < 90 && signal(1) < 4600)",
    "[]_[6,10] (signal(0) < 90 && signal(1) < 4700)",
    "[]_[6,10] (signal(0) < 95 && signal(1) < 4600)",
    "[]_[6,10] (signal(0) < 95 && signal(1) < 4700)",
    "[]_[6,10] (signal(0) < 100 && signal(1) < 4600)",
    "[]_[6,10] (signal(0) < 100 && signal(1) < 4700)",
    "[]_[6,10] (signal(0) < 105 && signal(1) < 4600)",
    "[]_[6,10] (signal(0) < 105 && signal(1) < 4700)",
    "[]_[11,15] (signal(0) < 90 && signal(1) < 4600)",
    "[]_[11,15] (signal(0) < 90 && signal(1) < 4700)",
    "[]_[11,15] (signal(0) < 95 && signal(1) < 4600)",
    "[]_[11,15] (signal(0) < 95 && signal(1) < 4700)",
    "[]_[11,15] (signal(0) < 100 && signal(1) < 4600)",
    "[]_[11,15] (signal(0) < 100 && signal(1) < 4700)",
    "[]_[11,15] (signal(0) < 105 && signal(1) < 4600)",
    "[]_[11,15] (signal(0) < 105 && signal(1) < 4700)",
    "[]_[16,20] (signal(0) < 90 && signal(1) < 4600)",
    "[]_[16,20] (signal(0) < 90 && signal(1) < 4700)",
    "[]_[16,20] (signal(0) < 95 && signal(1) < 4600)",
    "[]_[16,20] (signal(0) < 95 && signal(1) < 4700)",
    "[]_[16,20] (signal(0) < 100 && signal(1) < 4600)",
    "[]_[16,20] (signal(0) < 100 && signal(1) < 4700)",
    "[]_[16,20] (signal(0) < 105 && signal(1) < 4600)",
    "[]_[16,20] (signal(0) < 105 && signal(1) < 4700)",
