...
val velocityValues = listOf(100.0, 105.0, null)
...
val stlList = listOf(
    "[] ((signal(0) < 100 && signal(2) < 3) || signal(1) < 4600)",
    "[] ((signal(0) < 100 && signal(2) < 3) || signal(1) < 4650)",
    "[] ((signal(0) < 105 && signal(2) < 3) || signal(1) < 4600)",
    "[] ((signal(0) < 105 && signal(2) < 3) || signal(1) < 4650)"
