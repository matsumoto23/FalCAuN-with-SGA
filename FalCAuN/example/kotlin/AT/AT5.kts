...
val accelerationValues = listOf(4400.0, 4450.0, 4500.0, 4550.0, null)
val gearValues = listOf(1.0, null)
...
val stlList = listOf(
    "[] (signal(2) == 1 -> signal(1) < 4400)",
    "[] (signal(2) == 1 -> signal(1) < 4450)",
    "[] (signal(2) == 1 -> signal(1) < 4500)",
    "[] (signal(2) == 1 -> signal(1) < 4550)"
