    ...
    void toMealy1(){
        ...
        while(!unchecked.isEmpty()) {
            ...
            for (String input: sigma) {
                CompactTransition ex_transition = expected.getTransition(current_state, input);
                CompactTransition ac_transition = actual.getTransition(expect_to_actual.get(current_state), input);
