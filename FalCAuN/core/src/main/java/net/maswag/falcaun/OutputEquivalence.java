...
public class OutputEquivalence extends NumericSULMapper {
    ...
    public OutputEquivalence(List<Map<Character, Double>> inputMapper,
        ...
        this.gamma = constructAbstractAPs(abstractOutputs);
        createNBAs(partial);
