...
public class TemporalImply<I> extends AbstractTemporalLogic<I> {
    ...
    public String toAbstractString() {
        if (nonTemporal && iOType != IOType.BOTH) {
            return makeAbstractStringWithAtomicStrings(null);
        } else {
    ...
    public String toAbstractString(OutputEquivalence mapper) {
        if (nonTemporal && iOType != IOType.BOTH) {
            ...
            return String.format("( %s ) -> ( %s )", subFml1.toAbstractString(mapper), subFml2.toAbstractString(mapper));
        }
    }
    ...
    public TemporalLogic<I> derivativeOn(String a){
        return new TemporalOr<I>(new TemporalNot<I>(subFml1.derivativeOn(a)), subFml2.derivativeOn(a));
    }
    
    public TemporalLogic<I> toNnf(boolean negate){
        TemporalLogic<I> simplified = new TemporalOr<I>(new TemporalNot<I>(subFml1), subFml2);
    ...
    public List<TemporalLogic<I>> getAllConjunctions(){
        return Arrays.asList(new TemporalNot<I>(subFml1), subFml2);
    }
