...
public class NumericSULMapper implements SULMapper<String, String, List<Double>, IOSignalPiece<List<Double>>> {
    ...
    protected final List<Character> largestOutputs;
    private final SignalMapper sigMap;

    protected final List<List<Character>> abstractOutputs;
    ...
    public String mapOutput(IOSignalPiece<List<Double>> concreteIO) {
        ...
        // output for debug
        // String concreteString = concreteOutput.stream().map(x -> x.toString()).collect(Collectors.joining(" "));
        // System.out.println("Concrete Output: " + concreteString);
        ...
        // output for debug
        // System.out.println("Mapped Output: " + result.toString());
