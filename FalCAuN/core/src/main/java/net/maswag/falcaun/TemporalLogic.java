...
public interface TemporalLogic<I> extends Function<IOSignal<I>, Double> {
    ...
    String toAbstractString(OutputEquivalence mapper);
    ...
    default String toLTLString(OutputEquivalence mapper){
        return this.toAbstractString(mapper);
    }
    ...
    TemporalLogic<I> derivativeOn(String s);
